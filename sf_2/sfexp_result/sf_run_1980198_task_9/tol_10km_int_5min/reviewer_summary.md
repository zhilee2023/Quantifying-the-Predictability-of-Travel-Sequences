...
- `1.8`: compare `direct_ctw` (0.9409) against `vq_ctw` at `K=512` (1.0000).
- `2.3`: compare Markov baselines `order 1` (0.9026) and `order 2` (0.8995) against VQ-VAE.
...
- Interval 5 min, K=256, code 234: taxi, mean speed 12.01 km/h, mean step 1.00 km, radius 1.84 km.
- Interval 5 min, K=512, code 210: taxi, mean speed 12.01 km/h, mean step 1.00 km, radius 1.84 km.
- Interval 5 min, K=1024, code 882: taxi, mean speed 12.01 km/h, mean step 1.00 km, radius 1.84 km.
